...
function fifthVis() {
    ...
    //regName has the full/proper names of the regions
    ...
    function addComp() {
        //this function creates the whole vis
...
function seventhVis() {
    ...
    var margin = {top: 60,right: 200,bottom: 60,left: 90};
    ...
    function drawCircles() {
        ...
        var circles = svgContainer
            ...
            .on("mouseover", mouseover) //calls mouseover that shows tooltip
        ...
        //adds a "title" with the full region name
        ...
        function mouseover(d) {
            ...
            .style("opacity", 1);
            d3.select(this).attr("r", 14).style("opacity", 1); //makes the circle that has been hovered over appear larger
            }
        ...
        d3.select("div#seventh").append("button") //adds a button
            .attr("class", "button")
            .text("GLOBAL") //labels button
            .style("font-family","adobe-garamond-pro")
            .style("font-size","18px")
            .on("click", function(d) {
                circles //circles move away and become invisible
                    .transition()
                    .delay(100)
                    .duration(1000)
                    .attr("cy", function(d) {if (d.global == 1) {return drScale(d.death_rate);} else {return h;}})    
                ...
                regLabel //title name changes
                    .text("Global");
                legendSelect //circles in the legend move away and become invisible
...
function eighthVis() {
    ...
    var causesText = svgContainer
        ...
        .attr("text-anchor", "middle")
        .style("fill", "rgb(47,79,120)")
        .transition() //top causes move into the svg container
...
function ninthVis() {
    ...
    var causesText = svgContainer
        ...
        .attr("text-anchor", "middle")
        .style("fill", "rgb(47,79,120)")
        .transition() //causes move into the svg container
...
function lastVis() {
    ...
    var sectorCircle = svgContainer //adds four circles
        .selectAll("circle")
        .data(data)
        .enter()
        .append("circle")
    ...
    var moveCircle = sectorCircle //circles move towards each other
        .transition()
        .delay(1000)
        .duration(1000)
    ...
    var mergeCircles = moveCircle //circles merge
        .transition()
        .delay(2000)
        .duration(2500)
        .ease("bounce")
    ...
    var text1 = svgContainer
        ...
        .delay(5000)
        .duration(1500)
        .tween("text", function (d) { //"types" out the text
            var newText = d["text2"];
    ...
    var brainImage = svgContainer //adds the background image
        .append("svg:image")
...
// Boolean signals isX completion

var isSecond; //3000 a day
var isThird;  //under 5 vs 15 to 19
var isFourth; //boys more likely to die - text
var isFifth; //regional girl/boy comparison
var isSixth; //how are boys dying? - text
var isSeventh; // scatterplot
var isEighth; //top 3 causes of death - text
var isNinth; //little progress - text
var isTenth; //so if we want to help - text
var isLast; //"work across sectors..."
